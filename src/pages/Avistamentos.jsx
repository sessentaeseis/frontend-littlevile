                ...
                >
                  ...
                  <td>
                    ...
                    typeof a.longitude === 'number' ? (
                      <Link to="/mapa" className="map-pin-badge" title="Ver no mapa">
                        📍
                      </Link>
                    ) : (
                      <span className="map-pin-badge map-pin-badge-off" title="Sem localização real">
                        —
                      </span>
                    )}
                  </td>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <form className="form" onSubmit={salvar}>
              ...
              <div className="form-group">
                <label>Local no mapa (opcional)</label>
                <LocationPicker
                  latitude={form.latitude}
                  longitude={form.longitude}
                  onChange={(lat, lng) =>
